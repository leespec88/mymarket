		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<span class="form-group">
						<button class="btn btn-primary facebook"
							onclick="facebooklogin();">Facebook 계정으로 로그인</button> <span
						...
						data-theme="light" data-cookiepolicy="single_host_origin"
						data-requestvisibleactions="http://schemas.google.com/AddActivity"
						data-scope="https://www.googleapis.com/auth/plus.login">
							<button class="btn btn-default google">Google 계정으로 로그인</button>
					</span>
					</span>
				</div>
				<div class="modal-body">
				...
				<div class="modal-footer">
					...
					<p>
						회원이 아니신가요? <a href="/user/joinform">회원가입</a>
					</p>
				</div>
			</div>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<form class="navbar-form navbar-right" role="search"
					action="/searchMain" method="post">
					<div class="form-group">
						<input type="text" class="form-control" name="kwd"
							placeholder="상품검색창입니다.">
					</div>
